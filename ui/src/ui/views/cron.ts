...
export function renderCron(props: CronProps) {
  ...
  return html`
      ...
      <div class="card">
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          ...
          <div class="stat">
            ...
            <div class="stat-value">${props.status?.jobs ?? t("common.n/a")}</div>
          </div>
          <div class="stat">
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <div class="card-sub">${t("cron.runHistorySub")} ${props.runsJobId ?? t("cron.selectJobPlaceholder")}.</div>
    ...
    <div class=${itemClass} @click=${() => props.onLoadRuns(job.id)}>
      <div class="list-main">
        ...
        <div class="chip-row" style="margin-top: 6px;">
          <span class="chip">${job.enabled ? t("cron.enabled") : t("cron.disabled")}</span>
