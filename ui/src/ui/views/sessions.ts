...
const VERBOSE_LEVELS: ReadonlyArray<{ value: string; labelKey: string }> = [
  { value: "", labelKey: "sessions.verboseInherit" },
  { value: "off", labelKey: "sessions.verboseOff" },
  { value: "on", labelKey: "sessions.verboseOn" },
];
  ...
  return html`
    <section class="card">
      ...
      <div class="filters" style="margin-top: 14px;">
        <label class="field">
          <span>${t("sessions.activeWithinMinutes")}</span>
          <input
      ...
      <div>
        ...
        >
          ${thinkLevels.map((level) =>
            html`<option value=${level}>${level ? level : t("common.inherit")}</option>`,
          )}
        </select>
      </div>
      <div>
